...
/**
 * The {@code StyledDialog} class provides a modernized custom dialog with enhanced visual styling.
 * It is used to create professional notification pop-ups with a clean, cohesive design
 * that matches the game's visual identity.
 * 
 * <p>This class supports various dialog types, including:
 * <ul>
 ...
 * </ul>
 * 
 * <p>StyledDialog uses a modern color palette and custom painting to enhance the user experience.
 * 
...
public class StyledDialog extends JDialog {
     ...
     * @param type The type of dialog (INFORMATION, ERROR, WARNING, or CONFIRM)
     */
    ...
    /**
     * Creates a standard dialog for information, error, warning, or confirmation messages.
     * 
     * @param parent The parent component
     * @param title The title of the dialog
     * @param message The message to display in the dialog
     ...
     * @param message The message to display
     * @param title The title of the dialog
     * @return {@code JOptionPane.YES_OPTION} or {@code JOptionPane.NO_OPTION}
     */
