...
/**
 * The mainGame class represents the main gameplay window for the pet simulation game.
 * It handles the game's UI, pet interactions, and game logic, including score updates,
 * progress bar management, and event handling.
 * 
 * Features:
 * - Displays the pet and its stats (health, hunger, happiness, sleep).
 * - Allows interaction with commands, inventory, and settings.
 * - Handles animations, random events, and key bindings.
 * - Supports saving and restoring game state.
 * 
 * @author Omar Hossain, Ahmed Sinjab, jacob Tran
 */
public class mainGame extends javax.swing.JFrame {
    ...
    /**
     * Creates a new mainGame instance.
     * 
     * @param selectedPet The pet to use for this game.
     * @param saveData Optional save data to restore (can be null for a new game).
     */
    ...
    /**
     * Loads the pet image based on its current state and emotion.
     */
    ...
    /**
     * Takes the pet to the vet to restore its health.
     */
    ...
    /**
     * Depletes a specified JProgressBar from a given start value down to 0.
     ...
     * @param decrement The value to decrement the progress bar on each step.
     ...
     * 
     * @param evt The ActionEvent triggered by the save button.
     */
    ...
    /**
     * Sets up random blinking animations for the pet.
     */
    ...
    /**
     * Sets up random idle animations for the pet.
     */
    ...
    /**
     * Checks for low stats and displays warnings if necessary.
     */
