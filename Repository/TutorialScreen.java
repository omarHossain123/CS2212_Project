...
/**
 * The {@code TutorialScreen} class provides a multi-page tutorial walkthrough for the Virtual Pet Application.
 * It features styled navigation buttons and a visually appealing design that matches the main menu's aesthetic.
 * 
 * <p>This class includes:
 * <ul>
 *   <li>A step-by-step guide to the game's features and mechanics</li>
 *   <li>Custom navigation buttons for moving between tutorial pages</li>
 *   <li>Nature-themed background with gradient colors</li>
 *   <li>Content displayed in a semi-transparent styled panel</li>
 * </ul>
 * 
 * <p>Authors:
 * <ul>
...
public class TutorialScreen extends JDialog {
    ...
    /**
     * Constructs a new {@code TutorialScreen} dialog with no parent component.
     * This constructor initializes the tutorial walkthrough with default settings.
     */
    ...
    /**
     * Constructs a new {@code TutorialScreen} dialog with the specified parent component.
     * 
     * @param parent The parent {@code JFrame} for the tutorial dialog (can be null)
     */
    ...
    /**
     * Updates the current page of the tutorial.
     * This method updates the title, content, and navigation button states based on the current page.
     */
    ...
    /**
     * Creates a circular navigation button with custom styling.
     * 
     * @param text The text to display on the button
     * @param fontSize The font size of the button text
     * @return A styled circular {@code JButton}
     */
    ...
    /**
     * A custom JPanel class that provides a nature-themed background for the tutorial screen.
     * The background includes gradient colors, grass, and subtle decorative elements like clouds and a sun.
     */
